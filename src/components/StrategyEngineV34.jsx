...
import "../styles/StrategyEngineV34.css";
...
export default function StrategyEngineV34() {
  ...
  // V34: VRTC/virtual accounts are the safe executable lane; REAL remains selectable but locked.
  ...
  async function startBot() {
    ...
    try {
      // V34 fixes the V34 deadlock: Start establishes the authenticated
      // execution socket itself instead of waiting on tradingReady.
      await derivPublicClient.ensureTradingConnection();
      await derivPublicClient.subscribeTicks(effectiveSymbol);
    ...
    <div className="v30Shell">
      ...
      <main className="v30Main" id="engine">
        ...
        <section className="v30Hero">
          <div><div className="v30Eyebrow">CALIBRATED STRATEGY ENGINE · V34</div><h1>Deriv Strategy Engine</h1><p>Live analysis · Smart signals · Real results</p></div>
