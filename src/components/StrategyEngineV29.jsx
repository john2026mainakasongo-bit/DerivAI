...
import "../styles/StrategyEngineV29.css";
...
export default function StrategyEngineV28() {
  ...
  async function startBot() {
    ...
    if (!isDemo) {
      window.alert("Strategy Engine execution is Demo Account only. Switch the Deriv account selector to Demo before starting.");
      return;
    }
    if (!effectiveSymbol) {
        ...
        <section className="v28Workspace">
          ...
          <aside className="v28Right">
            <article className="v28Card tradeCard" id="settings">
              ...
              <button className="v28Start" type="button" disabled={busy || !isDemo || !connected || historySize < 8 || signal === "WAIT" || confidence < settings.minConfidence} onClick={startBot}>▶ START BOT</button>
