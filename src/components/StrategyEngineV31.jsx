...
import "../styles/StrategyEngineV31.css";
...
export default function StrategyEngineV31() {
      ...
      <main className="v30Main" id="engine">
        <header className="v30Topbar">
          ...
          <div className="v30TopRight">
            ...
            <div className="v30Account"><span>◉</span><strong>{Number(auth.selectedAccount?.balance || 0).toFixed(2)} USD</strong><small>{isDemo ? "Demo Account" : "Real Account"}</small></div>
            <button className="v30Logout" type="button" onClick={disconnect}>↪</button>
          </div>
        </header>
