    ...
    <div className="v30Shell">
      <aside className="v30Sidebar">
        ...
        <nav className="v30Nav">
          ...
          <a href="/command-center">◫ <span>Command Center</span></a>
        </nav>
      ...
      <main className="v30Main" id="engine">
        ...
        <section className="v30Hero">
          <div><div className="v30Eyebrow">CALIBRATED STRATEGY ENGINE · V36</div><h1>Deriv Strategy Engine</h1><p>Live analysis · Smart signals · Real results</p></div>
