...
export default function QuantumAIBot() {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      ...
      const fallback = markets[(currentIndex + 1) % markets.length];
      const nextSymbol = best?.symbol || fallback?.id;
      const nextLabel = best?.label || fallback?.label || nextSymbol;
  ...
  return (
    <div className="appShell quantumShell">
      ...
      <main className="mainContent quantumPage">
        <Topbar
          title="MetaBinary Quantum AI V24"
        ...
        <section className={`quantumHero ${running ? "running" : "idle"}`}>
          <div>
            ...
            <h1>MetaBinary Quantum AI V24</h1>
